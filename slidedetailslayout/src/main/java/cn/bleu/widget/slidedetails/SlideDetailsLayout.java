...
//        switch (mStatus){
//            case OPEN:
//                ViewPager viewPager = (ViewPager) vGroup.getChildAt(1);
//                switch (currentItem)
//
//                result=canChildScrollVertically(1);
//                break;
//            case CLOSE:
//
//                break;
//        }
        if (view instanceof ViewGroup) {
            ...
            for (int i = 0; i < vGroup.getChildCount(); i++) {
                ...
                if (child instanceof ViewPager){
                    ...
                    //return innerCanChildScrollVertically(adapter., direction);
                    return true;
                }else {
        ...
        return result||ViewCompat.canScrollVertically(view, direction);
    }
//    private boolean innerCanChildScrollVertically(View view, int direction) {
//        if (view instanceof ViewGroup) {
//            final ViewGroup vGroup = (ViewGroup) view;
