...
public class Loan {
     ...
     * remainingAmount : 650
     * saleAmount : 0
     * saleEndTime : 2018-02-01 00:00:00
     * saleStartTime : 2018-01-29 09:58:37
     * startBuyTime : 0时0分
     * totalAmount : 65000
     * totalBuyNumber : 0
     * totalCopies : 650
    ...
    public static Loan objectFromData(String str) {

        return new Gson().fromJson(str, Loan.class);
    }
