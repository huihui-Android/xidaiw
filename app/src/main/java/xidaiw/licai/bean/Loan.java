...
public class Loan {
    ...
    private String canJoinCode;
    private String canJoinMsg;
    private String endBuyTime;
    private String saleStartTime;
    private String cornerType;
    private String cornerSaleType;
    ...
    public String getAwardInterest() {
        return awardInterest;
    }

    public void setAwardInterest(String awardInterest) {
    ...
    public String getCanJoinCode() {
        return canJoinCode;
    }

    public void setCanJoinCode(String canJoinCode) {
        this.canJoinCode = canJoinCode;
    }

    public String getCanJoinMsg() {
        return canJoinMsg;
    }

    public void setCanJoinMsg(String canJoinMsg) {
        this.canJoinMsg = canJoinMsg;
    }

    public String getCornerSaleType() {
        return cornerSaleType;
    }

    public void setCornerSaleType(String cornerSaleType) {
        this.cornerSaleType = cornerSaleType;
    }
    ...
    public void setMinInterest(String minInterest) {
    ...
    public void setTotalBuyNumber(String totalBuyNumber) {
